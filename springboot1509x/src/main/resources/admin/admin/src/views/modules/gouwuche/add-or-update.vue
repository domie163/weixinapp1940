<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="购物车编号" prop="gouwuchebianhao">
					<el-input v-model="ruleForm.gouwuchebianhao" placeholder="购物车编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.gouwuchebianhao" label="购物车编号" prop="gouwuchebianhao">
					<el-input v-model="ruleForm.gouwuchebianhao" placeholder="购物车编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="加入时间" prop="jiarushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jiarushijian" label="加入时间" prop="jiarushijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="加入账号" prop="jiaruzhanghao">
					<el-input v-model="ruleForm.jiaruzhanghao" placeholder="加入账号" clearable  :readonly="ro.jiaruzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="加入账号" prop="jiaruzhanghao">
					<el-input v-model="ruleForm.jiaruzhanghao" placeholder="加入账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="加入姓名" prop="jiaruxingming">
					<el-input v-model="ruleForm.jiaruxingming" placeholder="加入姓名" clearable  :readonly="ro.jiaruxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="加入姓名" prop="jiaruxingming">
					<el-input v-model="ruleForm.jiaruxingming" placeholder="加入姓名" readonly></el-input>
				</el-form-item>
			</template>
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.yonghuzhanghao!=''&&json.yonghuzhanghao) || json.yonghuzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.jiaruzhanghao = json.yonghuzhanghao
						this.ro.jiaruzhanghao = true;
					}
					if(((json.yonghuxingming!=''&&json.yonghuxingming) || json.yonghuxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.jiaruxingming = json.yonghuxingming
						this.ro.jiaruxingming = true;
					}
				} else {
